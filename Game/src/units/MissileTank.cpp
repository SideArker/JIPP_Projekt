...
void registerMissileTank() {
  ...
  unitAnimSet
      .addDirectionalClips(
          "idle", AnimationClip::fromRow({0, 0}, {32, 32}, 2, 1.f, true, true),
          AnimationClip::fromRow({0, 64}, {32, 32}, 2, 1.f, true, false), // Up
          AnimationClip::fromRow({0, 32}, {32, 32}, 2, 1.f, true,
                                 false)) // Down
      ...
      .addDirectionalClips(
          ...
          "Art/Units/MissileTank/missiletank_move.png",
          "Art/Units/MissileTank/missiletank_move_mask.png")
      ...
      .addDirectionalClips(
          ...
          "Art/Units/MissileTank/missiletank_shoot.png",
          "Art/Units/MissileTank/missiletank_shoot_mask.png");
